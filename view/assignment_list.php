...
<section id="add" class="add">
    ...
    <form action="." method="post" id="add__form" class="add__form">
        ...
        <div class="add__inputs">
            <label>course:</label>
            <select name="course_id" required>
                <option value="">Select your task list:</option>
                <?php foreach ($courses as $course): ?>
                    <option value="<?= $course['courseID']; ?>">
                        <?= $course['courseName']; ?>
                    </option>
            ...
            <br>
            <label>Task:</label>
            <input type="text" name="description" maxlength="120" placeholder="What's your next task?" required>
        </div>
